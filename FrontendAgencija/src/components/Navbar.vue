<template>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        <a class="navbar-brand" href="#">Turisticka agencija</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <router-link :to="{name: 'AllProductsView'}" tag="a" class="nav-link" :class="{active: this.$router.currentRoute.name === 'AllProductsView'}">Aranzmani</router-link>
            </li>

            <li v-if="canLogout" class="nav-item">
              <router-link :to="{name: 'MyProductsView'}" tag="a" class="nav-link" :class="{active: this.$router.currentRoute.name === 'MyProductsView'}">MyReservations</router-link>
            </li>
          </ul>
